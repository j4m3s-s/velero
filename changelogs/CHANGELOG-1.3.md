...
### Download
https://github.com/j4m3s-s/velero/releases/tag/v1.3.2
...
### Download
https://github.com/j4m3s-s/velero/releases/tag/v1.3.1
...
### Download
https://github.com/j4m3s-s/velero/releases/tag/v1.3.0
...
- Support private registries with custom ports for the restic restore helper image ([PR #1999](https://github.com/j4m3s-s/velero/pull/1999), [@cognoz](https://github.com/cognoz))
- Use AWS profile from BackupStorageLocation when invoking restic ([PR #2096](https://github.com/j4m3s-s/velero/pull/2096), [@dinesh](https://github.com/dinesh))
- Allow restores from schedules in other clusters ([PR #2218](https://github.com/j4m3s-s/velero/pull/2218), [@cpanato](https://github.com/cpanato))
- Fix memory leak & race condition in restore code ([PR #2201](https://github.com/j4m3s-s/velero/pull/2201), [@skriss](https://github.com/skriss))
