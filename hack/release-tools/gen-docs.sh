...
if [[ $(uname) == "Darwin" ]]; then
    ...
    find $DOCS_DIRECTORY/${NEW_DOCS_VERSION} -type f -name "*.md" | xargs sed -i '' "s|https://github.com/j4m3s-s/velero/blob/$MAIN_BRANCH|https://github.com/j4m3s-s/velero/blob/$VELERO_VERSION|g"
